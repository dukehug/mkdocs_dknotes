...
Design --> Aesthetic & Functional & Economic & Socio-political & Considerations ;
```
...
```mermaid
graph TD;
A["Hick's Law"]--> B["relates to"];
B["relates to"] --> C["Congnitive Load"];
```
...
![](https://www.youtube.com/watch?v=za6mptzSn7o)
